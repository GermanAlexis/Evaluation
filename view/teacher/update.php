                        ...
                        <div>
                            ...
                            <!-- Form -->
                                ...
                                <div class="wrap-input100 validate-input" data-validate="Number is required">
                                    ...
                                    <input class="input100" type="text" name="id"  value="<?php  echo $key['teachers']['id_docente']?>" placeholder="Numero de identificacion">
                                    <span class="focus-input100"></span>
                                </div>

                                <div class="wrap-input100 validate-input" data-validate = "Name is required">
                                    <span class="label-input100"><i class="ti-user"></i>Nombre Completo</span>
                                    <input class="input100" type="text" name="name" value="<?php  echo $key['teachers']['names']?>"  placeholder="Nombre Completo">
                                    <span class="focus-input100"></span>
                                </div>

                                <div class="wrap-input100 validate-input" data-validate = "Email is required">
                                    <span class="label-input100"><i class="ti-email"></i>Correo</span>
                                    <input class="input100" type="email" name="email"  value="<?php  echo $key['teachers']['email']?>" placeholder="Email">
                                    <span class="focus-input100"></span>
                                </div>
